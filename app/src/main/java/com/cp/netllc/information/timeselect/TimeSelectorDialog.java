...
import com.cp.netllc.information.R;
  ...
  public void setType(int type){
   ...
   private int status=0;
    ...
    private void initView(){
        ...
        mButtonConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                date=str.substring(0,str.indexOf("年"))+"-"+hour.substring(0,hour.indexOf(("月")))+"-"+minute.substring(0,minute.indexOf(("日")));
    ...
    private void setAfterDate(){
            ...
            NumberFormat formatter = new DecimalFormat("00月");
                 NumberFormat formatters=null;
                 if(langue){
                      formatters = new DecimalFormat(("0000年"));
                 }else {
                      formatters = new DecimalFormat("0000");
                 }

            NumberFormat dayFormatter = new DecimalFormat(("00日"));
