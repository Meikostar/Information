...
public class NavigationBar extends LinearLayout implements View.OnClickListener {
    ...
    public NavigationBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        barStyle.right_imgId = a.getResourceId(R.styleable.NavigationBar_navigationRight_img,R.mipmap.arrow_left);
        ...
        barStyle.right_img = a.getResourceId(R.styleable.NavigationBar_right_img, R.mipmap.arrow_left);
