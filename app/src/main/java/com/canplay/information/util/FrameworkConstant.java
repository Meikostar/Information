...
public class FrameworkConstant {
     ...
     * 存放发送图片的目录
     */
    public static String PICTURE_PATH = Environment.getExternalStorageDirectory() + "/sedu590/image/";
    /**
     * 存放拍摄照片的目录
     */
    public static String PICTURE_APP_PATH = Environment.getExternalStorageDirectory() + "/sedu590/image/";///marvoto/baby_image/

    /**
     * 存放截图图片的目录
     */
    public static String CROPPICTURE_PATH = Environment
            .getExternalStorageDirectory() + "/sedu590/image/crop";

    /**
     * 存放视频目录
     */
    public static String VIDEO_PATH = Environment
            .getExternalStorageDirectory() + "/sedu590/videp/";
